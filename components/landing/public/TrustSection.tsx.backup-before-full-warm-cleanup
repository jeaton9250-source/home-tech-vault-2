...
export default function TrustSection() {
  return (
    <section
      ...
      className="relative overflow-hidden bg-[#0f1d2b] px-5 py-24 text-[#f4f0e8] md:px-8 md:py-32 lg:px-12"
    >
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-[1180px]">
        <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-[#8ca667]/25 bg-[#8ca667]/10 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-[#a9bd86]">
              <ShieldCheck
                size={14}
                aria-hidden
              />
            ...
            <h2 className="mt-7 max-w-xl font-serif text-4xl font-medium leading-[1.06] tracking-[-0.045em] text-[#f4f0e8] sm:text-5xl lg:text-[3.5rem]">
            ...
            <p className="mt-6 max-w-xl text-base leading-8 text-[#b7c0c7] sm:text-lg">
              ...
              network details belong in one organized place — without turning
              your home inventory into public information.
            </p>

            <Link
              href="/trust"
              className="mt-8 inline-flex min-h-11 items-center gap-2 rounded-xl border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-[#f4f0e8] transition hover:border-[#8ca667]/45 hover:bg-[#8ca667]/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#8ca667]"
            >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {trustItems.map(
              ({
                ...
                <article
                  key={title}
                  className="rounded-[24px] border border-white/10 bg-white/[0.045] p-6 backdrop-blur-sm transition hover:border-[#8ca667]/25 hover:bg-white/[0.065] sm:p-7"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[#8ca667]/20 bg-[#8ca667]/10 text-[#a9bd86]">
                    <Icon
                      size={19}
                      aria-hidden
                    />
                  ...
                  <h3 className="mt-6 text-base font-semibold tracking-[-0.015em] text-[#f4f0e8]">
                    {title}
                  </h3>
