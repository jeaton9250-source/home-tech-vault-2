    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Card style={styles.pushCard}>
          ...
          <View style={styles.pushCopy}><Text style={styles.pushTitle}>{permission === 'granted' ? 'Home reminders are on' : 'Let your home remind you'}</Text><Text style={styles.pushBody}>{permission === 'granted' ? 'Warranty and care reminders are scheduled on this phone.' : 'Get a gentle alert before warranties end and home care comes due.'}</Text></View>
