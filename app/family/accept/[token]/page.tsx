...
export default function FamilyPage() {
  ...
  const [creatingHousehold, setCreatingHousehold] =
    useState(false);
  ...
  const [inviteForm, setInviteForm] =
    useState<InviteForm>(initialInviteForm);
  ...
  const loadFamilyData = useCallback(async () => {
    if (demoLoading || subscriptionLoading) {
      return;
    }
    ...
    try {
      ...
      const loadedMemberRows =
        (membersResult.data || []) as HouseholdMemberRow[];

      const memberUserIds = loadedMemberRows.map(
      ...
      setHousehold(
        (householdResult.data as Household) || null
      );
  ...
  const canCreateHousehold =
    isAdmin || canUseFamilySharing;

  const hasHouseholdMembership =
    Boolean(household && currentRole);
  ...
  async function updateMemberRole(
    ...
    try {
      ...
      setSuccessMessage(
        `${member.fullName} is now a ${formatRole(role)}.`
      );
    } catch (error: unknown) {
      const possibleError = error as {
        message?: string;
      ...
      <PageShell>
        <section className="rounded-[32px] bg-[#111827] px-6 py-9 text-white shadow-sm md:px-10 md:py-11">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-white/60 md:text-base">
            Invite household members and
            manage your home technology
            together.
          </p>
        </section>
        ...
        <PageCard className="overflow-hidden p-0">
          <div className="bg-[#111827] p-8 text-white md:p-10">
            ...
            <h2 className="mt-3 max-w-2xl text-3xl font-semibold tracking-[-0.04em]">
              Bring your household into
              one shared vault.
            </h2>

            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/60">
              Family Sharing is available
              only with the Family plan.
              Share devices, documents,
              warranties, maintenance,
              subscriptions, reports, and
              network information.
            </p>
      ...
      <section className="rounded-[32px] bg-[#111827] px-6 py-9 text-white shadow-sm md:px-10 md:py-11">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-xl text-sm leading-7 text-white/60 md:text-base">
              Invite trusted people and
              manage your Home Tech Vault
              together.
            </p>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-neutral-600">
                ...
                Creating invitations or
                changing members will take
                you to signup.
              </p>
            </div>
          </div>
          ...
          <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
            ...
            <PageCard className="p-7 md:p-8">
              ...
              <div className="mt-6 rounded-[22px] border border-[#E8E2D6] p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-neutral-500">
                  Invitations are stored
                  securely. Automatic email
      ...
      <div className="grid lg:grid-cols-[0.8fr_1.2fr]">
        <div className="bg-[#111827] p-8 text-white md:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-white/60">
            Your household is the shared
            space where family members
            will access devices,
            documents, warranties, and
