  ...
  return (
    <PageShell>
      <PageTitle
        ...
        description={
          isDemo
            ? "Explore sample devices and see how Home Tech Vault organizes your technology."
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-500">
                {hasUnlimitedDevices
                  ? "Your plan supports unlimited device tracking."
                  : deviceLimitReached
                    ? "You have reached the 8-device limit for free accounts."
                    : "Free accounts can save up to 8 devices."}
              </p>
            </div>
      ...
      {isDemo && !loading && (
        <PageCard className="border-[#D8C69D] bg-[#FFF8E8]">
          ...
          <h2 className="mt-2 text-xl font-bold text-[#111827]">
            Browse a sample device inventory
          </h2>

          <p className="mt-2 text-sm leading-6 text-neutral-600">
            Search, sort, and filter the sample
            devices below. Demo information is not
      ...
      {loading ? (
        ...
        <PageCard className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-neutral-500">
            ...
            tracking photos, warranties,
            purchase details, and documents.
          </p>
