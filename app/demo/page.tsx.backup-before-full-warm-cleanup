    ...
    <MarketingLayout minimalNav>
      <MarketingContent className="py-0">
        ...
        <section className="relative overflow-hidden px-0 pb-24 pt-20 md:pb-32 md:pt-28">
          ...
          <div className="relative grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <h1 className="mt-6 max-w-2xl font-serif text-4xl font-medium leading-[1.02] tracking-[-0.05em] text-[#f4f0e8] sm:text-5xl lg:text-6xl">
              ...
              <p className="mt-7 max-w-xl text-base leading-8 text-[#aeb8c1]">
              ...
              <button
                type="button"
                onClick={enterDemo}
                className="mt-9 inline-flex min-h-[52px] items-center justify-center gap-2 rounded-xl border border-[#8ba866]/45 bg-[#617c43] px-7 text-sm font-semibold text-white shadow-[0_20px_40px_-20px_rgba(97,124,67,0.8)] transition hover:bg-[#718d4f]"
              >
                Enter the Demo
            ...
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-[30px] border border-white/15 bg-[#101d2b] shadow-[0_40px_100px_-35px_rgba(0,0,0,0.85)]">
                <div className="flex items-center justify-between border-b border-white/10 bg-[#132536] px-6 py-5">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#718d4f]/25 bg-[#718d4f]/10 text-[#8ca667]">
                      <ShieldCheck size={18} />
                    </div>
                  ...
                  <span className="rounded-full border border-[#718d4f]/25 bg-[#718d4f]/10 px-3 py-1.5 text-[9px] font-semibold uppercase tracking-[0.1em] text-[#8ca667]">
                    Demo Mode
                  </span>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    <PreviewRow
                      icon={Radar}
                      title="Network center"
                      text="Connected technology context"
                    />

                    <PreviewRow
                      icon={FileText}
                      title="Documents"
                      text="Receipts, manuals and records"
                    />

                    <PreviewRow
                      icon={Wrench}
                      title="Maintenance"
                      text="Upcoming work and service history"
                    />
                  </div>
                  ...
                  <div className="mt-5 rounded-2xl border border-[#718d4f]/20 bg-[#718d4f]/8 p-4">
                    ...
                    <p className="mt-2 text-[10px] leading-5 text-white/35">
                      Explore the product without adding your own information.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="border-t border-white/10 py-20 md:py-28">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-5 max-w-lg font-serif text-4xl font-medium leading-[1.03] tracking-[-0.045em] text-[#f4f0e8] sm:text-5xl">
            ...
            {demoFeatures.map((feature) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-7 font-serif text-xl text-[#f4f0e8]">
                    {feature.title}
                  </h3>

                  <p className="mt-3 text-sm leading-6 text-[#8f9ba4]">
                    {feature.description}
                  </p>
        ...
        <section className="border-t border-white/10 py-24 text-center md:py-32">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-2xl border border-[#718d4f]/25 bg-[#718d4f]/10 text-[#8ca667]">
            <House size={20} />
          </div>

          <h2 className="mx-auto mt-6 max-w-3xl font-serif text-4xl font-medium leading-[1.03] tracking-[-0.045em] text-[#f4f0e8] sm:text-5xl">
            Ready to step inside the Vault?
          </h2>

          <p className="mx-auto mt-5 max-w-xl text-base leading-8 text-[#aeb8c1]">
