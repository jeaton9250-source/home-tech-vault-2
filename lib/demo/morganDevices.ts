...
export const morganDevices: DemoDevice[] = [
  buildDevice({
    ...
    brand: "Samsung",
    category: "TV",
    model_number: '65" QLED (2019)',
    serial_number: "SAM-TV-65-8842",
  ...
  buildDevice({
    ...
    serial_number: "EPSON-ET3850-1102",
  ...
  buildDevice({
    ...
    model_number: "Echo Dot (5th Gen)",
    serial_number: "ECHO-DOT5-2201",
    purchase_date: "2024-04-02",
    warranty_date: "2025-04-02",
    purchase_price: 99,
    location: "Kitchen",
    notes: "Kitchen hub for timers, recipes, and household voice commands.",
    ip_suffix: 55,
  }),
  buildDevice({
    id: "demo-lg-washer",
