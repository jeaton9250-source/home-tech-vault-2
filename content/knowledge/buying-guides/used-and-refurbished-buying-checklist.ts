...
const article = {
  ...
  "description": "Serial checks, remaining warranty, reset status, and documentation to demand before a secondhand purchase sticks.",
  "publishedAt": "2026-06-11",
  "updatedAt": "2026-06-11",
  "heroCaption": "Serial checks, remaining warranty, reset status, and documentation to demand before a secondhand purchase sticks.",
  "intro": [
    "Serial checks, remaining warranty, reset status, and documentation to demand before a secondhand purchase sticks. Most homes only feel the gap when something breaks, goes missing, or a stranger on the phone asks for details nobody wrote down.",
  ...
  "sections": [
    {
      "id": "verify-serial-and-reset-status",
      "heading": "Verify serial and reset status",
      "paragraphs": [
        "Get specific about “verify serial and reset status” using your rooms, people, and gear — not a generic internet checklist. Measure the shelf and check the outlet before the product page talks you into it. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “verify serial and reset status” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    {
      "id": "ask-for-proof-of-purchase-if-any",
      "heading": "Ask for proof of purchase if any",
      "paragraphs": [
        "Get specific about “ask for proof of purchase if any” using your rooms, people, and gear — not a generic internet checklist. Buy for the Wi-Fi and ports you have, not the ones in the marketing photo. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        ...
        "When “ask for proof of purchase if any” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "inspect-ports-and-batteries",
      "heading": "Inspect ports and batteries",
      "paragraphs": [
        "Get specific about “inspect ports and batteries” using your rooms, people, and gear — not a generic internet checklist. Write who will own the account and the warranty in a shared household. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “inspect ports and batteries” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    {
      "id": "check-account-locks",
      "heading": "Check account locks",
      "paragraphs": [
        "Get specific about “check account locks” using your rooms, people, and gear — not a generic internet checklist. If it is used or refurbished, verify reset status and serial before you pay. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        ...
        "When “check account locks” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "document-seller-details",
      "heading": "Document seller details",
      "paragraphs": [
        "Get specific about “document seller details” using your rooms, people, and gear — not a generic internet checklist. Unbox into your records the same day — serials vanish with packaging. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “document seller details” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    {
      "id": "create-inventory-on-arrival",
      "heading": "Create inventory on arrival",
      "paragraphs": [
        "Get specific about “create inventory on arrival” using your rooms, people, and gear — not a generic internet checklist. Keep gift receipts and return windows where calm-you can find them. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        "If two adults share the house, name who updates this so it is not ambient guilt. Date the last review even if nothing changed, so the record feels alive.",
        "When “create inventory on arrival” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "watch-return-windows-closely",
      "heading": "Watch return windows closely",
      "paragraphs": [
        "Get specific about “watch return windows closely” using your rooms, people, and gear — not a generic internet checklist. Score options against real rooms and real people, not feature checklists alone. That sounds small until you are the person on the phone trying to remember it.",
        "Leave blanks when you are unsure — a visible gap beats a confident wrong answer. Keep notes short enough that you will open them again next month.",
        "When “watch return windows closely” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week."
      ]
    },
    {
      "id": "avoid-deals-that-block-registration",
      "heading": "Avoid deals that block registration",
      "paragraphs": [
        ...
        "Date the last review even if nothing changed, so the record feels alive. When the house and your notes disagree, trust the house and fix the notes the same day.",
        "When “avoid deals that block registration” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive."
      ]
    }
  ],
  "faq": [
