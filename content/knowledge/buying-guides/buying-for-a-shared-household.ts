...
const article = {
  ...
  "description": "Decide ownership, accounts, and documentation up front when multiple people will use — and inherit — the device.",
  "publishedAt": "2026-06-13",
  "updatedAt": "2026-06-13",
  "heroCaption": "Decide ownership, accounts, and documentation up front when multiple people will use — and inherit — the device.",
  "intro": [
    "Decide ownership, accounts, and documentation up front when multiple people will use — and inherit — the device. Most homes only feel the gap when something breaks, goes missing, or a stranger on the phone asks for details nobody wrote down.",
  ...
  "sections": [
    {
      "id": "decide-ownership-before-checkout",
      "heading": "Decide ownership before checkout",
      "paragraphs": [
        "Get specific about “decide ownership before checkout” using your rooms, people, and gear — not a generic internet checklist. Measure the shelf and check the outlet before the product page talks you into it. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “decide ownership before checkout” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    {
      "id": "agree-on-account-emails",
      "heading": "Agree on account emails",
      "paragraphs": [
        "Get specific about “agree on account emails” using your rooms, people, and gear — not a generic internet checklist. Buy for the Wi-Fi and ports you have, not the ones in the marketing photo. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        ...
        "When “agree on account emails” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "plan-warranty-responsibility",
      "heading": "Plan warranty responsibility",
      "paragraphs": [
        "Get specific about “plan warranty responsibility” using your rooms, people, and gear — not a generic internet checklist. Write who will own the account and the warranty in a shared household. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “plan warranty responsibility” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    {
      "id": "write-cost-sharing-if-needed",
      "heading": "Write cost sharing if needed",
      "paragraphs": [
        "Get specific about “write cost sharing if needed” using your rooms, people, and gear — not a generic internet checklist. If it is used or refurbished, verify reset status and serial before you pay. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        ...
        "When “write cost sharing if needed” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "avoid-surprise-shared-network-purchases",
      "heading": "Avoid surprise shared-network purchases",
      "paragraphs": [
        "Get specific about “avoid surprise shared-network purchases” using your rooms, people, and gear — not a generic internet checklist. Unbox into your records the same day — serials vanish with packaging. That sounds small until you are the person on the phone trying to remember it.",
        ...
        "When “avoid surprise shared-network purchases” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Get specific about “document the decision” using your rooms, people, and gear — not a generic internet checklist. Keep gift receipts and return windows where calm-you can find them. If two people share the house, decide who owns the update so it does not float as ambient guilt.",
        "If two adults share the house, name who updates this so it is not ambient guilt. Date the last review even if nothing changed, so the record feels alive.",
        "When “document the decision” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive.",
    ...
    {
      "id": "onboard-everyone-to-the-record",
      "heading": "Onboard everyone to the record",
      "paragraphs": [
        "Get specific about “onboard everyone to the record” using your rooms, people, and gear — not a generic internet checklist. Score options against real rooms and real people, not feature checklists alone. That sounds small until you are the person on the phone trying to remember it.",
        "Leave blanks when you are unsure — a visible gap beats a confident wrong answer. Keep notes short enough that you will open them again next month.",
        "When “onboard everyone to the record” is good enough to use tonight, stop polishing and move on. Write it while the thing is in your hands; memory gets creative after a week."
      ]
    },
    {
      "id": "revisit-after-roommate-changes",
      "heading": "Revisit after roommate changes",
      "paragraphs": [
        ...
        "Date the last review even if nothing changed, so the record feels alive. When the house and your notes disagree, trust the house and fix the notes the same day.",
        "When “revisit after roommate changes” is good enough to use tonight, stop polishing and move on. The goal is calmer Tuesdays, not a museum-quality archive."
      ]
    }
  ],
  "faq": [
